...
public class EmployeeChangeRequestController {
    ...
    @GetMapping({"/hradmin/pending", "/ceo/pending"})
    ...
    @GetMapping({"/hradmin/{requestId}", "/ceo/{requestId}"})
    ...
    @PostMapping({"/hradmin/{requestId}/approve", "/ceo/{requestId}/approve"})
    ...
    @PostMapping({"/hradmin/{requestId}/reject", "/ceo/{requestId}/reject"})
