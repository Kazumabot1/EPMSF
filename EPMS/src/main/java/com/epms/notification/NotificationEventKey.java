...
public final class NotificationEventKey {
    ...
    public static final String SELF_ASSESSMENT_FORM_OPENED = "SELF_ASSESSMENT_FORM_OPENED";
    public static final String SELF_ASSESSMENT_FORM_CLOSED = "SELF_ASSESSMENT_FORM_CLOSED";
    public static final String SELF_ASSESSMENT_SUBMITTED = "SELF_ASSESSMENT_SUBMITTED";
    public static final String SELF_ASSESSMENT_MANAGER_APPROVED = "SELF_ASSESSMENT_MANAGER_APPROVED";
    public static final String SELF_ASSESSMENT_WAITING_HR = "SELF_ASSESSMENT_WAITING_HR";
    public static final String SELF_ASSESSMENT_HR_APPROVED = "SELF_ASSESSMENT_HR_APPROVED";
    public static final String SELF_ASSESSMENT_REJECTED = "SELF_ASSESSMENT_REJECTED";
    public static final String SELF_ASSESSMENT_RESUBMIT_ALLOWED = "SELF_ASSESSMENT_RESUBMIT_ALLOWED";
