...
public class OnboardingEmailService {
    ...
    public EmailSendResult sendTemporaryPasswordEmail(
        ...
        if (!StringUtils.hasText(temporaryPassword)) {
            return emailResult(false, "Temporary password is empty.");
        }
        ...
        String body = """
                ...
                Please copy only the password line above. Do not include any spaces or punctuation before or after it.
    ...
    public EmailSendResult sendForgotPasswordOtpEmail(
        ...
        if (!StringUtils.hasText(otp)) {
            return emailResult(false, "OTP is empty.");
        }
        ...
        String body = """
                ...
                Your EPMS password reset OTP is:
    ...
    private EmailSendResult emailResult(boolean sent, String safeErrorDetail) {
        EmailSendResult result = new EmailSendResult();
        result.setSent(sent);
        result.setSafeErrorDetail(safeErrorDetail);
        return result;
    }
