...
// import type { FeedbackCampaign, FeedbackCampaignPayload } from '../../types/feedback';
// import {
//   EmptyState,
//   MetricCard,
//   SectionIntro,
...
//     setForm({
//       name: campaign.name,
//       campaignType: campaign.campaignType ?? DEFAULT_CAMPAIGN_TYPE,
...
//         campaignType: savedCampaign.campaignType ?? DEFAULT_CAMPAIGN_TYPE,
//         reviewYear: savedCampaign.reviewYear ?? Number((savedCampaign.startDate ?? new Date().toISOString()).slice(0, 4)),
//         startDate: savedCampaign.startDate,
//         endDate: savedCampaign.endDate,
//         status: savedCampaign.status,
//         formId: savedCampaign.formId ?? null,
//       });
//     } catch (e) {
...
//                     min="2000"
//                     max="2100"
//                     value={form.reviewYear ?? new Date().getFullYear()}
//                     onChange={(e) => setForm((current) => ({ ...current, reviewYear: Number(e.target.value) }))}
//                 />
//               </div>
//
//               <div className="feedback-field">
